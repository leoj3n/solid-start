...
function Nav() {
  ...
  return (
    <nav class="min-w-[300px] col-start-1 row-start-2 -translate-x-full peer-checked:translate-x-0 space-y-4 h-full fixed md:relative left-0 z-20 md:left-auto top-[52px] md:top-auto overflow-auto bg-slate-100 duration-300 ease-in-out md:translate-x-0 pb-12 md:pb-0">
      <ScrollIndicator>
        <div id="docsearch" />
        <For each={data()}>
          {r => (
